...
namespace RailRoadControllerTest.BL.Locomotive
{
    public class LocomotivePersisterTest
    {
        ...
        public void Locomotive_informations_are_correctly_saved_to_disk_and_retrieved()
        {
            ...
            var input = new List<RailRoadController.Entities.Locomotive>
            {
                new RailRoadController.Entities.Locomotive {Name = "Locomotive one", Address = "02"},
                new RailRoadController.Entities.Locomotive {Name = "locomotive two", Address = "01"}
            };
